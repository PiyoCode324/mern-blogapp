        ...
        <div className="lg:w=3/5 flex flex-col gap-8">
          <h1 className="text-xl md:text-3xl xl:text-4xl 2xl:text-5xl font-semibold">
            ...
            <p className="text-gray-500 font-medium">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium possimus pariatur assumenda esse, quisquam maxime facere rerum vero quae dolor autem aliquid. Obcaecati accusantium recusandae possimus quo ut ab repellendus.
            </p>
        </div>
